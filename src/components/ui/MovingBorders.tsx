  ...
  return (
    <Component
      className={cn(
        ...
        "bg-gray-900 relative text-xl p-[1px]  md:col-span-2 md:row-span-1 after:content-[''] after:absolute after:inset-0 overflow-hidden after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20",
        containerClassName
      )}
      style={{
