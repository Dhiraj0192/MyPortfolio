...
export const AboutSection = () => {
  return (
    <section className="py-18 lg:py-10 sm:pt-10 " id="about">
      <div className="container">
        ...
        <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 lg:max-w-2xl max-w-md mx-auto">
          2 years ago, I began freelancing as a developer. Since then, I've done
          remote work for different companies, consulted for startups, and
          collaborated on digital products for business and consumer use.
        </p>
        
        
        <div className="mt-10 flex flex-col justify-center gap-6 -z-10">
          <div className=" md:grid md:grid-cols-5 lg:grid-cols-3 md:gap-5 flex flex-col gap-6">
            {/* card */}
            <div className="md:col-span-2 lg:col-span-1 bg-gray-900 rounded-3xl relative after:content-[''] after:absolute after:inset-0 overflow-hidden after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-5 pt-8 md:pt-12 md:px-10 lg:pt-8 lg:px-10 after:pointer-events-none hover:-rotate-3 transition duration-300">
              <div className="flex flex-col">
                <div className="inline-flex items-center gap-2">
                  <StarIcon className="size-9 text-emerald-300" />
                  <h3 className="font-serif text-3xl">My Reads</h3>
                </div>
                <p className="text-sm w-full text-white/60 mt-2">
                  ...
                  {[...new Array(2)].fill(0).map((_, index) => (
                    <Fragment key={index}>
                      {toolboxItems.map((item) => (
                        <div
                          className="inline-flex items-center gap-6 py-2 px-3 outline outline-2 outline-white/10 rounded-lg"
                          key={item.title}
                        >
            ...
            <div className="lg:h-[190px] md:col-span-3 lg:col-span-2 bg-gray-900 rounded-3xl relative after:content-[''] after:absolute after:inset-0 z-0 after:z-10 overflow-hidden after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-5 pt-8 md:pt-12 md:px-10 after:pointer-events-non lg:pt-8 lg:px-10 hover:rotate-3 transition duration-300">
              ...
              <div className="mb-6">
                {hobbies.map((hobby) => (
                  <div
                    key={hobby.title}
                    className="inline-flex items-center gap-2 px-6 mt-6 mr-2 bg-gradient-to-r from-emerald-300 to-sky-400 rounded-full py-1.5"
                  >
